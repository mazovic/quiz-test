...
export default function NewQuizPage() {
  ...
  const categories = [
    { id: "ProblemSolvingBeginner", name: "Problem Solving", icon: "Beginner" }, 
    { id: "ProblemSolvingIntermediate", name: "Problem Solving", icon: "Intermediate" },
    { id: "ProblemSolvingAdvanced", name: "Problem Solving", icon: "Advanced" },
    { id: "ProblemSolvingTrees", name: "Problem Solving", icon: "Trees" },
    { id: "ProblemSolvingMath", name: "Problem Solving", icon: "Math" },
